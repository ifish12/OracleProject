package com.jac.cs.myapplication.utility;
...
public class HttpJsonRequest {
     ...
     * @throws IOException
     */
    public static com.jac.cs.myapplication.utility.HttpResponse make(String urlStr, String method) throws IOException {
